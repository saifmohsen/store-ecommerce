...
{{--طبعا هاي الميثود بتجيبلي اللغة الحالية للموقع من ملف app --}}
{{-- واستخدمتها هان عشان يغيرلي اتجاه لوحة التحكم ع حسب اللغة --}}
{{-- هلقيت لازم اطبق هاي الميثود على اي ملف css  --}}
{{-- مثلا عندي هاد href="{{asset('assets/admin/css-rtl/plugins/animate/animate.css')}}"
  --}}
{{-- هلقيت لازم اغير كلمة css-rtl على اي ملف حسب اللغة يعني لو عربي يجيبلي ملف css-rtl غير هيك يجيب css بدلا منه  --}}
{{-- هلقيت الافضل اني اروح انشأ مجلد اسميه مثلا helper واعمل فيه ملف بينفذلي هاي الميثود --}}
{{-- وبستدعي هاي الميثود بدلا من كلمةcss-rtl وهاي الميثود راخ تحددلي الملف بناء عى اللغة سواء كان css-rtl او  css   --}}
