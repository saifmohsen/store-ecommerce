            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
                <div class="card border-grey border-lighten-3 m-0">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{ route('check.admin.login') }}" method="post"
                                  novalidate>
                                @csrf
                                ...
                                <fieldset class="form-group position-relative has-icon-left mb-0">
                                    ...
                                    <!--ال $message هي عبارة عن الرسالة اللي عاملها انا بالفاليديشن اللر راح تظهر لو في خطأ -->
                                    <!-- ال $message متغير من لارافيل بينفعش احط غيره-->
                                    @enderror
                                </fieldset>
