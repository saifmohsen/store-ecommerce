        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('main-categories.index') }}"
                                          data-i18n="nav.dash.ecommerce"> {{__('admin/sidebar.show all')}} </a>
                    </li>
                    <li><a class="menu-item" href="{{ route('main-categories.create') }}" data-i18n="nav.dash.crypto"> {{__('admin/sidebar.add new section')}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('sub-categories.index') }}"
                                          data-i18n="nav.dash.ecommerce"> {{__('admin/sidebar.show all')}} </a>
                    </li>
                    <li><a class="menu-item" href="{{ route('sub-categories.create') }}" data-i18n="nav.dash.crypto">{{__('admin/sidebar.add new subsections')}}</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">   {{__('admin/sidebar.Correspondence tickets')}} </span>
                    <span
                        class="badge badge badge-danger  badge-pill float-right mr-2">0</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href=""
                                          data-i18n="nav.dash.ecommerce"> {{__('admin/sidebar.students tickets')}} </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main"> {{__('admin/sidebar.shipping methods')}}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{route('get.shipping.methods','inner')}}">
                                {{__('admin/sidebar.Internal delivery')}} </a>
                            </li>
                            <li><a class="menu-item" href="{{route('get.shipping.methods','outer')}}"
